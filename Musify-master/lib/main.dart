...
// The following code has multiple code smells and anti-patterns such as
//      1.  dependencies are not defined because of old version of SDK.
//      2. Classes and functions are not well-defined.
//      3. Logical errors
//      4. Weak code structure
//      5. Undefined Names
//      6. Incorrect Methodes.
//      7. Sequences of classes and objects is not correct.
//      8. Variables are not defined
//      9. URI that uses the “http” or “https” scheme does not exists
//     10. Extra and useless function are implemented
//     11. Dependency upgradations fails due to old version of IDE and SDK
